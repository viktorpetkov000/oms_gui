...
form1Data = [
  ...
  {type: "block",offsetTop:10,list: [
    {type:"button", value:"Prepare", name:"prepare", offsetLeft: 60},
    {type:"newcolumn"},
    {type:"button", value:"Update", name:"update", disabled:"true", offsetLeft:3},
    {type:"newcolumn"},
    {type:"button", value:"Delete", name:"delete", offsetLeft: 3},
    {type:"button", value:"Submit", name:"submit", offsetTop: 5, offsetLeft: 2},
  ]},
]
...
listData = [
  ...
  {"id":"6","name":"Nick Kompot","settings":""},
  {"id":"7","name":"Potato","settings":""},
